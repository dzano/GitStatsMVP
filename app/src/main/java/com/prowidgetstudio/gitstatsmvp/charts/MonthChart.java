...
import com.prowidgetstudio.gitstatsmvp.customViews.CustomMarkerViewMonth;
...
public class MonthChart {
    ...
    public MonthChart(Context context, LineChart chart) {
    ...
    public void showData(ArrayList<Entry> valLine, ArrayList<Entry> valCircle, int max) {
        ...
        // postavljam markere
        CustomMarkerViewMonth markerView = new CustomMarkerViewMonth(context, R.layout.custom_marker_view);
    ...
    private void setData(ArrayList<Entry> valLine, ArrayList<Entry> valCircle) {
        ...
        if (chart.getData() != null && chart.getData().getDataSetCount() > 0) {
            ...
            set1.setColor(Color.parseColor("#FFFFCC33"));
            set1.setCircleColor(Color.parseColor("#FFFFCC33"));
            ...
            set1.setValueTextColor(Color.parseColor("#FFFFCC33"));
            ;
            ...
            set2.setCircleColor(Color.parseColor("#FFFFCC33"));
            ...
            set2.setValueTextColor(Color.parseColor("#FFFFCC33"));
