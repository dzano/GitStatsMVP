...
import com.prowidgetstudio.gitstatsmvp.customViews.CustomMarkerView;
...
public class DayChart implements OnChartValueSelectedListener {

    private Context context;
    private LineChart chart;
    // create marker to display box when values are selected

    public DayChart(Context context, LineChart chart) {
    ...
    public void showData(ArrayList<Entry> valLine, ArrayList<Entry> valCircle, int max) {
        ...
        chart.setViewPortOffsets(20f, -1f, 20f, 0f);
        chart.setDrawGridBackground(false);
    ...
    private void setData(ArrayList<Entry> valLine, ArrayList<Entry> valCircle) {
        ...
        if (chart.getData() != null && chart.getData().getDataSetCount() > 0) {
            ...
            set1.setColor(Color.parseColor("#FF007AFF"));
            set1.setCircleColor(Color.parseColor("#FF007AFF"));
            ...
            set1.setValueTextColor(Color.parseColor("#FF007AFF"));
            ;
            ...
            set2.setCircleColor(Color.parseColor("#FF007AFF"));
            ...
            set2.setValueTextColor(Color.parseColor("#FF007AFF"));
